...
const { createUsers ,getUsers ,getUser} = require("../Services/UsersService");
const { createUserValidation ,getOneUserValidator } = require("../Resuble/UserValidation");
// const {
...
Routes.route("/").post(UserValidation, createUsers).get(getUsers);
