...
exports.createTask = async (req, res) => {
  const { taskName, taskDuration, taskType, taskNotes, assignedTo } =
    req.body;
...
exports.getLoggedTask = factory.getOne(TaskModel)
...
// exports.getTasksForAccountant = async (req, res) => {
//   const user = req.user;
...
//   }
// };
// exports.getTasksForMarketer = async (req, res) => {
//   const user = req.user;
...
//       return res
//         .status(403)
//         .json({ message: "فقط المسوق يمكنه عرض مهامه الخاصة." });
//     }
