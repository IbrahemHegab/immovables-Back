...
const createGallerysModel = require("../Modules/createGallerys");
...
exports.getGalleryr = factory.getOne(createGallerysModel);

exports.deleteGalleryr =expressAsyncHandler(async (req, res, next) => {
...
exports.updateGalleryr = factory.updateOne(createGallerysModel)
